...
public class MessageSourceHierarchicalChanger {
    ...
    @Resource(name = com.cloud.baowang.common.data.transfer.i18n.DynamicMessageSource.DYNAMIC_MESSAGE_SOURCE_BEAN_NAME)
    private com.cloud.baowang.common.data.transfer.i18n.DynamicMessageSource dynamicMessageSource;
