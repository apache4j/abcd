 ...
 *
 */
@FeignClient(contextId = "remoteExchangeRateApi",value = ApiConstants.NAME)
@Tag(name = "RPC 服务 - 法定货币配置")
public interface ExchangeRateConfigApi {


    String PREFIX = ApiConstants.PREFIX + "/exchange/rate/";
    ...
    BigDecimal getLatestRate(@RequestBody RateCalculateRequestVO exchangeRateRequestVO);
}
