...
@FeignClient(contextId = "remoteRiskBlackApi",value = ApiConstants.NAME)
@Tag(name = "RPC 服务 - 黑名单")
public interface RiskCtrlBlackApi {

    String PREFIX = ApiConstants.PREFIX + "/risk/black/api/";
