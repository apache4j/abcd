...
public class SiteBannerConfigPageRespVO {
    ...
    @Schema(description = "h5banner图片code")
    @I18nField(type = I18nFieldTypeConstants.FILE)
    private String h5BannerName;

    private String h5BannerNameFileUrl;


    @Schema(description = "黑底轮播图i18-皮肤4-pc")
    @I18nField(type = I18nFieldTypeConstants.FILE)
    private String darkBannerUrl;

    @Schema(description = "黑底轮播图-皮肤4")
    private String darkBannerUrlFileUrl;


    @Schema(description = "黑底轮播图i18-皮肤4-h5")
    @I18nField(type = I18nFieldTypeConstants.FILE)
    private String darkH5BannerUrl;

    @Schema(description = "黑底轮播图-皮肤4-h5")
    private String darkH5BannerUrlFileUrl;
