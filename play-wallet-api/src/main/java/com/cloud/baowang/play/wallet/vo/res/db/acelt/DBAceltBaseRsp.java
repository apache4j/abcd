package com.cloud.baowang.play.wallet.vo.res.db.acelt;
...
public class DBAceltBaseRsp<T> {
    ...
    public static <T> DBAceltBaseRsp<T> success(Integer code, T data) {
        return new DBAceltBaseRsp<>(code,AceltErrorEnum.SUCCESS.getMsg(),data);
    }
    ...
    public static <T> DBAceltBaseRsp<T> success(AceltErrorEnum resultCodeEnums, T data) {
        return new DBAceltBaseRsp<>(resultCodeEnums.getCode(),resultCodeEnums.getMsg(), data);
    }



    public static <T> DBAceltBaseRsp<T> failed(AceltErrorEnum resultCodeEnums) {
        return new DBAceltBaseRsp<>(resultCodeEnums.getCode(),resultCodeEnums.getMsg(),null);
    }
    ...
    public static <T> DBAceltBaseRsp<T> success(Integer code) {
        return new DBAceltBaseRsp<>(code,AceltErrorEnum.SUCCESS.getMsg(),null);
    }
}
