...
import com.cloud.baowang.play.wallet.service.DBFishingGameApi;
...
@AllArgsConstructor
@Service
public class DBFishingGameApiImpl extends BaseService implements DBFishingGameApi {
    ...
    public DBEVGBaseRsp checkRequestValid(UserInfoVO userInfoVO) {
        ...
        SiteVenueInfoCheckVO checkVO = SiteVenueInfoCheckVO.builder().siteCode(userInfoVO.getSiteCode())
                .venueCode(VenueEnum.DBFISHING.getVenueCode())
        ...
        if (venueInfoVO == null || !venueInfoVO.getStatus().equals(StatusEnum.OPEN.getCode())) {
            log.info("该站:{} 没有分配:{} 场馆的权限", userInfoVO.getSiteCode(), VenueEnum.DBFISHING.getVenueCode());
    ...
    protected CoinRecordResultVO handleSettleCoin(UserInfoVO userInfoVO, String orderNo, BigDecimal payoutAmount, String remark) {
        ...
        userCoinAddVOPayout.setVenueCode(VenueEnum.DBFISHING.getVenueCode());
