package com.cloud.baowang.site.utils;
...
public class SecurityUtils {
    ...
    public static void main(String[] args) {
        String pas = "aa123456";
        String enp = encryptPassword(pas);
        System.out.println(enp);
        boolean b = matchesPassword(pas, "$2a$10$IrwmvspGANLWmwCoSAOpLeFgsOUnaY69uMNyNDjOStNAYxI00zyQa");
