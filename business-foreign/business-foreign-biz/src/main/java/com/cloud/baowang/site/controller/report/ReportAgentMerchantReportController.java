...
@RestController
@Tag(name = "商务后台-商务报表")
@RequestMapping("/business-report/api")
@AllArgsConstructor
public class ReportAgentMerchantReportController {
    ...
    public ResponseVO<ReportAgentMerchantStaticsResult> listPage(@Valid @RequestBody ReportAgentMerchantStaticsPageVO reportAgentMerchantStaticsPageVO) {
        ...
        reportAgentMerchantStaticsPageVO.setMerchantAccount(currentUserAccount);
    ...
    public ResponseVO<String> export(@Valid @RequestBody ReportAgentMerchantStaticsPageVO reportAgentMerchantStaticsPageVO) {
        ...
        ResponseVO<String> upload =  minioUploadApi.uploadXlsxAndFileExport(
                UploadXlsxVO.builder()
                        ...
                        .byteArray(byteArray)
                        .pageName(CommonConstant.AGENT_MERCHANT_STATIC_REPORT_BUSINESS)
