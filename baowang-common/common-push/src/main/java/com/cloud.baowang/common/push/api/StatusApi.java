...
import com.cloud.baowang.common.push.bean.status.MessageLifecycleGetParam;
import com.cloud.baowang.common.push.bean.status.UserStatusGetResult;
import com.cloud.baowang.common.push.bean.status.UserStatusGetParam;
import com.cloud.baowang.common.push.bean.status.MessageStatusGetResult;
import com.cloud.baowang.common.push.bean.status.MessageStatusGetParam;
import com.cloud.baowang.common.push.bean.status.MessageLifecycleGetResult;


import com.cloud.baowang.common.push.client.StatusClient;
