package com.cloud.baowang.common.push.bean.push.message.liveactivity;

import com.cloud.baowang.common.push.enums.event.Event;
...
public class LiveActivityMessage {
    ...
    public static class LiveActivityIOS {
        ...
        private Map<String, Object> attributesType;

        /**
         * 必填
         * 实时活动动态内容，需与客户端 SDK 值匹配（对应 Apple 官方的content-state 字段），类型也必须匹配，否则不展示
         * 这里的Object，可以是基础数据类型
         */
