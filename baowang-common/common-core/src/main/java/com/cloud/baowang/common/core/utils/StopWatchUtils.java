...
public class StopWatchUtils {
     ...
     */
    public StopWatchUtils(String id) {
        this.id = id;
    }
    ...
    public String shortSummary() {
        ...
        return id + "总耗时: " + getTotalTimeNanos() / NANOS + "(ms)";
    }
    ...
    public String prettyPrint() {
        ...
        if (!this.keepTaskList) {
            ...
            for (TaskInfo task : getTaskInfo()) {
                sb.append(task.getTaskName()).append(" ").append(pf.format((double) task.getTimeNanos() / getTotalTimeNanos())).append(" ");
                sb.append(task.getTimeNanos() / NANOS).append("(ms) | ");
            }
        }
        return sb.toString();
    }
