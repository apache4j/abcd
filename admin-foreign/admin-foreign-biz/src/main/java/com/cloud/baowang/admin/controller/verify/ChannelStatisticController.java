...
public class ChannelStatisticController {
    ...
    public ResponseVO<ChannelSendStatisticRspVO> pageQuery(@RequestBody ChannelSendStatisticQueryVO queryVO) {
        ...
        queryVO.setChannelType(CommonConstant.business_one_str);
        return ResponseVO.success(statisticApi.pageQuery(queryVO));
    }


    @Operation(summary = "通道下sms发送量明细")
    ...
    @PostMapping("export")
    @Operation(summary = "短信统计报表导出")
    public ResponseVO<?> export(@RequestBody ChannelSendStatisticQueryVO vo){
        String adminId = CurrReqUtils.getOneId();
        String uniqueKey = "smsExport::centerControl::smsStatistic::" + adminId;
        ...
        vo.setChannelType(CommonConstant.business_one_str);
        ...
        byte[] byteArray = ExcelUtil.writeForParallel(
                ChannelSendingStatisticExportVO.class,
                vo,
                4,
                ExcelUtil.getPages(vo.getPageSize(), total),
                param -> ConvertUtil.entityListToModelList(statisticApi.pageQuery(param).getPages().getRecords(), ChannelSendingStatisticExportVO.class));
        ...
        return minioUploadApi.uploadXlsxAndFileExport(
                UploadXlsxVO.builder()
                        ...
                        .byteArray(byteArray)
                        .pageName(CommonConstant.SMS_STATISTIC_RECORD)
