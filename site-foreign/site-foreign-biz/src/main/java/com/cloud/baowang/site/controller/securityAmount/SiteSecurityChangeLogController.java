package com.cloud.baowang.site.controller.securityAmount;
...
@RestController
@AllArgsConstructor
@RequestMapping("/security-changeLog/api")
public class SiteSecurityChangeLogController {
    ...
    ResponseVO<SiteSecurityChangeLogAllRespVO> listPage(@RequestBody SiteSecurityChangeLogPageReqVO siteSecurityChangeLogPageReqVO){
        siteSecurityChangeLogPageReqVO.setSiteCode(CurrReqUtils.getSiteCode());
    ...
    public ResponseVO<?> export(@RequestBody SiteSecurityChangeLogPageReqVO vo) {
        ...
        String uniqueKey = "tableExport:siteSecurityChangeLogReport:export:" +CurrReqUtils.getSiteCode()+":"+ adminId;
