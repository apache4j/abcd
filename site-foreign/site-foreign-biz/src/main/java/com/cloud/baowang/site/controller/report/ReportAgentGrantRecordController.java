...
@RestController
@Slf4j
@RequestMapping("/reportAgentGrantRecord/api")
public class ReportAgentGrantRecordController {
    ...
    public ResponseVO<Map<String, List<CodeValueVO>>> getDownBox() {
        ...
        types.add(CommonConstant.AGENT_TYPE);
    ...
    public ResponseVO<?> export(@RequestBody CommissionGranRecordReqVO vo, HttpServletResponse response) {
        ...
        String uniqueKey = "tableExport::centerControl::commissionGranRecord::" + adminId;
        ...
        return minioUploadApi.uploadXlsxAndFileExport(
                UploadXlsxVO.builder()
                        ...
                        .byteArray(byteArray)
                        .pageName(CommonConstant.AGENT_COMMISSION_GRANT_RECORD)
