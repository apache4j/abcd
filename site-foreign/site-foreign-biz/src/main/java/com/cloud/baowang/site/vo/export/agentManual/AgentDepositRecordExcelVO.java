...
public class AgentDepositRecordExcelVO {
    ...
    public String getPaymentAccountInformation() {
        return StringUtils.isNotBlank(paymentAccountInformation) ? paymentAccountInformation.replaceAll("\\$\\$", "\n") : "";
    }
...
//    @ExcelProperty("后台备注")
    ...
    @Schema(description = "存款凭证")
    @I18nField(type = I18nFieldTypeConstants.FILE)
    private String cashFlowFile;

    @Schema(description = "存款凭证完整路径")
    @ExcelProperty("存款凭证")
    @ColumnWidth(50)
    private String cashFlowFileFileUrl;
