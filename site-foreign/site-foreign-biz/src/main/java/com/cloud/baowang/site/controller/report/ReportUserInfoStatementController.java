...
import com.cloud.baowang.report.api.vo.excel.UserInfoStatementExportVO;
...
@AllArgsConstructor
public class ReportUserInfoStatementController {
    ...
    public ResponseVO<UserInfoStatementResponseVO> pageList(@RequestBody ReportUserInfoStatementPageVO vo) {
        String uniqueKey = "ReportUserInfoStatementController::pageList::"  + CurrReqUtils.getOneId();
    ...
    public ResponseVO<?> export(@RequestBody ReportUserInfoStatementPageVO vo) {
        ...
        for (String str : vo.getIncludeColumnList()) {//totalPreference
        ...
        byte[] byteArray = ExcelUtil.writeForParallel(
                UserInfoStatementExportVO.class,//3.
                vo,
                4,
