...
public class UserCoinRecordController {
    ...
    public ResponseVO<?> export(@RequestBody UserCoinRecordRequestVO vo){
        ...
        byte[] byteArray = ExcelUtil.writeForParallel(
                ...
                param -> ConvertUtil.entityListToModelList(userCoinRecordApi.listUserCoinRecordPage(param).getData().getUserCoinRecordVOPage().getRecords(), UserCoinRecordExportVO.class));
