package com.cloud.baowang.site.vo.export.commission;
 ...
 * @description: 代理佣金审核记录导出对象
 */
@Data
@I18nClass
@ExcelIgnoreUnannotated
@Schema(title = "代理佣金审核记录对象")
public class AgentCommissionReviewRecordExportVO extends BaseVO {
    @Schema(title = "操作 ")
    ...
    /** {@link com.cloud.baowang.common.core.enums.agent.commission.CommissionTypeEnum}*/
    /** 佣金类型 */
    ...
    @ExcelProperty(value = "佣金金额", order = 8)
    @ColumnWidth(25)
    ...
    @ExcelProperty(value = "审核员", order = 10)
    @ColumnWidth(25)
    ...
    @Schema(description = "结算时间范围， 用于导出")
    @ExcelProperty(value = "结算时间范围", order = 6)
    @ColumnWidth(25)
    private String settleTimeScope;

    @Schema(description = "审核时间， 用于导出")
    @ExcelProperty(value = "审核时间", order = 11)
    @ColumnWidth(25)
    private String reviewTime;

    @Schema(description = "审核用时， 用于导出")
    @ExcelProperty(value = "审核用时", order = 12)
    @ColumnWidth(25)
    private String reviewTimeTotal;

    @Schema(description = "申请时间，用于导出")
    ...
    public String getSettleTimeScope() {
        if (oneReviewFinishTime == null || oneReviewStartTime == null) return null;
        String start = TimeZoneUtils.formatTimestampToTimeZone(oneReviewStartTime, CurrReqUtils.getTimezone());
        String end = TimeZoneUtils.formatTimestampToTimeZone(oneReviewFinishTime, CurrReqUtils.getTimezone());
        return start + "-" + end;
    }
    ...
    public String getApplyTimeText() {
        if (applyTime == null) return null;
        return TimeZoneUtils.formatTimestampToTimeZone(applyTime, CurrReqUtils.getTimezone());
    }
}
