...
@FeignClient(contextId = "remoteUserPlatformCoinManualUpReviewRecordApi", value = ApiConstants.NAME)
@Tag(name = "RPC 会员平台币上分审核记录 服务")
public interface UserPlatformCoinManualUpReviewRecordApi {

    String PREFIX = ApiConstants.PREFIX + "/userPlatformCoinManualUpReviewRecordApi/api/";
