...
public class GameClassInfoAddRequest {

    @Schema(description = "默认-目录名称-中文")
    private String directoryName;

    @Schema(description = "默认-首页名称-中文")
    ...
    @Schema(description = "图标1", required = true)
    private String icon;

    @Schema(description = "图标2", required = true)
    private String icon2;


    @Schema(description = "一级分类图片-多语言 字典code:language_type", required = true)
    private List<I18nMsgFrontVO> typeIconI18nCodeList;

    @Schema(description = "状态 字典code:platform_class_status_type")
    private Integer status;

    @Schema(description = "类型 字典code:add_game_one_type")
