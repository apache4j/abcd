...
/**
 * CreditRequest
 * 返奖请求对象，用于记录玩家游戏中返奖（加款）的信息
 * Credit request object used to record player credit transactions in games.
 */
@Data
public class CreditRequest implements Serializable {
    ...
    /**
     * 唯一请求 ID，用于标识一次 CreditRequest
     * Unique request Id, that identifies CreditRequest
     */
    private String uuid;
    ...
    public static class Transaction implements Serializable {
        ...
        /**
         * 返奖金额（按运营商设置进行四舍五入）
         * Amount of credit transaction in player's session currency
         */
