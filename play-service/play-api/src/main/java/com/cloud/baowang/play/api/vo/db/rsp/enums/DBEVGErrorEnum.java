package com.cloud.baowang.play.api.vo.db.rsp.enums;
...
public enum DBEVGErrorEnum {
    ...
    SIGN_ERROR(10003, "验签错误"),
    SYSTEM_MAINTAINED(10004, "内部服务器错误"),
     ...
     * 根据 code 获取枚举
     */
    public static DBEVGErrorEnum fromCode(int code) {
        for (DBEVGErrorEnum e : values()) {
            if (e.getCode() == code) {
                return e;
            }
        }
