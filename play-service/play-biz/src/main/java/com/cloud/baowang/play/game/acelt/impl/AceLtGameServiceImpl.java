...
@Slf4j
@Service(ServiceType.GAME_THIRD_API_SERVICE + VenuePlatformConstants.ACELT)
@AllArgsConstructor
public class AceLtGameServiceImpl extends GameBaseService implements GameService {
