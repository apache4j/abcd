 ...
 */
package com.cloud.baowang.play.task.pulltask.db.evg;
 ...
 */
@Log4j2
@Component(ThirdGamePullBetTaskTypeConstant.DB_EVG_GAME_PULL_BET_TASK)
@AllArgsConstructor
public class DBEVGGamePullBetTask extends BasePullBetTask {

    private final DBEVGServiceImpl evgGameService;
    ...
    protected VenuePullBetParams pullBetRecord(VenueInfoVO venueDetailVO, String pullParamJson) {
        ...
        while (pullType) {
            ...
            ResponseVO<?> responseVO = evgGameService.getBetRecordList(venueDetailVO, venuePullParamVO);
    ...
    protected String getVenuePlatform() {
        return VenuePlatformConstants.DBEVG;
    }
