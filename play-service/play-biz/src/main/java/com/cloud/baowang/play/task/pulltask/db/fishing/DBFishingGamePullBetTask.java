 ...
 */
package com.cloud.baowang.play.task.pulltask.db.fishing;
 ...
 */
@Log4j2
@Component(ThirdGamePullBetTaskTypeConstant.DB_FISHING_GAME_PULL_BET_TASK)
@AllArgsConstructor
public class DBFishingGamePullBetTask extends BasePullBetTask {
    ...
    protected VenuePullBetParams pullBetRecord(VenueInfoVO venueDetailVO, String pullParamJson) {
        ...
        while (pullType) {
            ...
            ResponseVO<?> responseVO = fishingService.getBetRecordList(venueDetailVO, venuePullParamVO);
    ...
    protected String getVenuePlatform() {
        return VenuePlatformConstants.DBFISHING;
    }
    ...
    protected VenuePullBetParams initPullParams(String startTime) {
        ...
        venuePullBetParams.setEndTime(startTimeLong + (10 * 60 * 1000));
        return venuePullBetParams;
    }
}
