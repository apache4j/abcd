//package com.cloud.baowang.play.game.omg.jiliplus;
//
//
...
//
//@Slf4j
//@Service(ServiceType.GAME_THIRD_API_SERVICE + VenuePlatformConstants.JILIPLUS_03)
//public class JiliPlus03GameServiceImpl extends OmgGameService {
//
//
//    @Override
