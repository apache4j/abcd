...
@I18nClass
public class ReportAgentTeamVO implements Serializable {
 ...
 //   private Long monthAddActiveCount;
    ...
    public List<ReportUserVenueTopVO> getWinLoseTopThree() {
        return Optional.ofNullable(winLoseTopThree).orElse(new ArrayList<>());
    }

    public List<ReportUserVenueTopVO> getBetsTopThree() {
