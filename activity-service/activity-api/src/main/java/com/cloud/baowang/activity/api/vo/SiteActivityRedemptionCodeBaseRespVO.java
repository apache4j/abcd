...
@Builder
@AllArgsConstructor
public class SiteActivityRedemptionCodeBaseRespVO implements Serializable {
    ...
    /**
     * 兑换码总数量-按币种统计,可直接从明细表中获取
     */
    @Schema(description = "兑换码总数量-按币种统计")
    private Integer quantity;

    @Schema(description = "已兑换码数量-按币种统计")
    private Integer exchangedCount;

    @Schema(description = "已兑换的兑换码列表-按币种统计")
    private List<SiteActivityRedemptionCodeExchangeVO> exchangedVOS;
     ...
     * 兑换码明细
     */
    @Schema(description = "兑换码明细")
    private SiteActivityRedemptionCodeDetailVO siteActivityRedemptionCodeDetailVO;
