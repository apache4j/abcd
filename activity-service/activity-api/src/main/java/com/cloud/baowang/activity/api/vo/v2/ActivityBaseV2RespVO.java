...
@I18nClass
public class ActivityBaseV2RespVO {
    ...
    @Schema(description = "入口图-移动端-黑夜-list")
    ...
    @Schema(description = "入口图-PC端-黑夜-list")
    ...
    @Schema(description = "活动头图-移动端-黑夜-list")
