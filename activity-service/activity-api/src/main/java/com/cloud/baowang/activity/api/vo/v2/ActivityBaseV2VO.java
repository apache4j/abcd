...
@Schema(title = "活动基础信息")
@I18nClass
public class ActivityBaseV2VO implements Serializable {
    ...
    @Schema(title = "入口图-移动端-黑夜-code")
    @I18nField(type = I18nFieldTypeConstants.DICT_LIST)
    private String entrancePictureBlackI18nCode;

    @Schema(title = "入口图-移动端-黑夜-list")
    //@NotNull(message = ConstantsCode.PARAM_ERROR)
    private List<I18nMsgFrontVO> entrancePictureBlackI18nCodeList;
    ...
    @Schema(title = "入口图-PC端-黑夜-code")
    @I18nField(type = I18nFieldTypeConstants.DICT_LIST)
    private String entrancePicturePcBlackI18nCode;

    @Schema(title = "入口图-PC端-黑夜-list")
    @NotNull(message = ConstantsCode.PARAM_ERROR)
    private List<I18nMsgFrontVO> entrancePicturePcBlackI18nCodeList;
    ...
    @Schema(title = "活动头图-移动端-黑夜-code")
    @I18nField(type = I18nFieldTypeConstants.DICT_LIST)
    private String headPictureBlackI18nCode;

    @Schema(title = "活动头图-移动端-黑夜-list")
    //@NotNull(message = ConstantsCode.PARAM_ERROR)
    private List<I18nMsgFrontVO> headPictureBlackI18nCodeList;
    ...
    @Schema(title = "活动头图-PC端-黑夜-code")
    @I18nField(type = I18nFieldTypeConstants.DICT_LIST)
    private String headPicturePcBlackI18nCode;

    @Schema(title = "活动头图-PC端-黑夜-list")
    //@NotNull(message = ConstantsCode.PARAM_ERROR)
    private List<I18nMsgFrontVO> headPicturePcBlackI18nCodeList;

    @Schema(title = "注册成功弹窗展示图(移动)-code")
    @I18nField(type = I18nFieldTypeConstants.DICT_LIST)
    private String recommendTerminalsPicI18nCode;

    @Schema(title = "注册成功弹窗展示图(移动)-list")
    //@NotNull(message = ConstantsCode.PARAM_ERROR)
    private List<I18nMsgFrontVO> recommendTerminalsPicI18nCodeList;

    @Schema(title = "注册成功弹窗展示图(PC)-code")
    @I18nField(type = I18nFieldTypeConstants.DICT_LIST)
    private String recommendTerminalsPicPcI18nCode;

    @Schema(title = "注册成功弹窗展示图(PC)-list")
    //@NotNull(message = ConstantsCode.PARAM_ERROR)
    private List<I18nMsgFrontVO> recommendTerminalsPicPcI18nCodeList;
    ...
    public boolean isRecommend(){
        return this.getRecommended()!=null?this.getRecommended():false;
    }
    ...
    @Schema(title = "弹窗宣传图PC")
    private List<I18nMsgFrontVO> picShowupPcI18nCodeList;
    ...
    @Schema(title = "弹窗宣传图APP")
    private List<I18nMsgFrontVO> picShowupAppI18nCodeList;
