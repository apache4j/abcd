...
@Slf4j
@I18nClass
public class ActivityAssignDayVenueVO {
    ...
    public List<ActivityAssignDayCondVO> getActivityAssignDayCondVOList() {
        ...
        if (!CollectionUtils.isEmpty(this.getFixCondVOList()) && this.discountType.equals(ActivityDiscountTypeEnum.FIXED_AMOUNT.getType())) {
            list.addAll(this.getFixCondVOList());
        }
        if (this.getPercentCondVO() != null && this.discountType.equals(ActivityDiscountTypeEnum.PERCENTAGE.getType())) {
