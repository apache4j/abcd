...
@NoArgsConstructor
@I18nClass
public class ActivityLossInSportsRespVO extends ActivityBaseRespVO implements Serializable {
    ...
    @Schema(description = "派发方式: 字典CODE:calculate_type ", required = true)
    @NotNull(message = ConstantsCode.PARAM_ERROR)
    ...
    @Schema(description = "注册天数", required = true)
