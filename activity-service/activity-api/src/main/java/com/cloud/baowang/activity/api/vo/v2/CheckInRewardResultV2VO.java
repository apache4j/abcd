...
import com.cloud.baowang.activity.api.vo.CheckInRewardFreeGamePPDTO;
...
@Data
@I18nClass
public class CheckInRewardResultV2VO {
    ...
    private final Integer acquireSpinNum = 0;
    @Schema(description = "免费旋转次数，0表示没有")
    private final Integer acquireFreeNum = 0;

    @Schema(description = "赠送金额,0表示没有")
    private final BigDecimal acquireAmount = BigDecimal.ZERO;
    /**
     * 免费游戏参数
     */
