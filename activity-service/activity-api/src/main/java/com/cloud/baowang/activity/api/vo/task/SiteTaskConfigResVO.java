...
@NoArgsConstructor
@I18nClass
public class SiteTaskConfigResVO {
    @Schema(title = "任务id")
    private String id;
    /**
     * 任务名称-多语言
     ...
     */
    @Schema(title = "场馆类型: 1:体育 2:视讯 3:棋牌 4:电子,场馆类型：字典CODE：venue_type")
     ...
     * 游戏场馆CODE
     */
    @Schema(title = "游戏场馆CODE,场馆名称：接口：/venue_info/api/venueInfoList")
    private List<String> venueCode;

    /**
     * 游戏场馆CODE
     */
    @Schema(title = "游戏场馆名称,场馆名称：接口：/venue_info/api/venueInfoList")
    private List<String> venueCodeName;
