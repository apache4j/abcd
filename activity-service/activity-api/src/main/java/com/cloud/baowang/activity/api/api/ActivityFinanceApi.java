 ...
 * 活动资金流水记录
 */
@FeignClient(contextId = "activityFinanceApi", value = ApiConstants.NAME)
@Tag(name = "活动资金流水-接口")
public interface ActivityFinanceApi {

    String PREFIX = ApiConstants.PREFIX +"/"+ApiConstants.PATH+ "/activityFinance/api/";
