...
import com.cloud.baowang.activity.api.vo.ActivityDailyRobotRespVO;
...
import com.cloud.baowang.activity.api.vo.ActivityPartDailyCompletionUserRespVO;
import com.cloud.baowang.activity.api.vo.ActivityPartDailyCompletionVenueDetailRespVO;
import com.cloud.baowang.activity.api.vo.ActivityPartDailyCompletionVenueRespVO;
import com.cloud.baowang.activity.api.vo.ActivityPartDailyPreviousRespVO;
import com.cloud.baowang.activity.api.vo.ActivityPartDailyRecordRespVO;
import com.cloud.baowang.activity.api.vo.ActivityPartUserRankingDailyRespVO;
...
@Slf4j
@Service
public class SiteActivityDetailService {
    ...
    public ActivityRewardVO getBatchActivityReward(String userId) {
        List<SiteActivityOrderRecordPO> list = siteActivityOrderRecordService.getBaseMapper()
                .selectList(Wrappers.lambdaQuery(SiteActivityOrderRecordPO.class)
                        .eq(SiteActivityOrderRecordPO::getSiteCode, CurrReqUtils.getSiteCode())
        ...
        SiteActivityDetailService siteActivityDetailService = applicationContext.getBean(SiteActivityDetailService.class);
        for (SiteActivityOrderRecordPO activityOrderRecordPO : list) {
    ...
    public ActivityRewardVO getActivityReward(String id, String userId) {
        ...
        try {
            ...
            SiteActivityOrderRecordPO siteActivityOrderRecordPO = siteActivityOrderRecordService.getBaseMapper().selectOne(Wrappers.lambdaQuery(SiteActivityOrderRecordPO.class)
                    .eq(SiteActivityOrderRecordPO::getSiteCode, CurrReqUtils.getSiteCode())
                    .eq(SiteActivityOrderRecordPO::getId, id)
                    .eq(SiteActivityOrderRecordPO::getUserId, CurrReqUtils.getOneId()));
