...
@FieldNameConstants
@TableName("agent_deposit_withdrawal")
public class AgentDepositWithdrawalPO extends BasePO {
     ...
     * 平台币汇率
     */
    private BigDecimal platformCurrencyExchangeRate;

    /**
     * WTC-USD汇率，用于保证金计算
     */
    private BigDecimal wtcUsdExchangeRate;
     ...
     *
     * @see {@link DepositWithdrawalOrderStatusEnum }
     */
