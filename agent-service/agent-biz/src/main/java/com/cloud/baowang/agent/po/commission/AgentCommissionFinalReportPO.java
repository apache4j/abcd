 ...
 * @description: 代理每月佣金信息表
 */
@Data
@TableName("agent_commission_final_report")
@Schema(title = "AgentCommissionDay对象", description = "代理每月佣金信息表")
public class AgentCommissionFinalReportPO extends BasePO {
    /** siteCode */
