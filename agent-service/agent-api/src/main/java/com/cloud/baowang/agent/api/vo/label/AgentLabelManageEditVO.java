 ...
 */
@Data
@Schema(title = "代理标签管理-代理标签修改对象", description = "代理标签管理-代理标签修改对象")
public class AgentLabelManageEditVO {
    @Schema(description = "siteCode",hidden = true)
    private String siteCode;

    @NotBlank(message = "修改之前标签名称不能为空")
    @Schema(title = "修改之前标签名称")
    private String beforeLabel;

    @NotBlank(message = "修改之后标签名称不能为空")
    @Schema(title = "修改之后标签名称")
