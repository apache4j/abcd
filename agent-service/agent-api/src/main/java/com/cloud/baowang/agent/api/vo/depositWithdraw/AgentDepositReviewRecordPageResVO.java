...
@Data
@I18nClass
@Schema(title = "代理存款审核记录列表返回对象")
public class AgentDepositReviewRecordPageResVO {
    ...
    private String platformCurrencyCode=CommonConstant.PLAT_CURRENCY_CODE;
    ...
    private String platformCurrencyExchangeRate;
