...
public class UserNoticeConfigAddModifyVO implements Serializable {
    /**
     * 通知类型(1:公告2:通知 3:活动)
     */
    ...
    /**
     * 当发送对象是会员的时候
     * 会员类型 会员类型 1:全部会员 2:特定会员 3:全部代理 4:特定代理
     */
    @Schema(title = "发送对象类型 1:全部会员 2:特定会员 ")
    ...
    private List<String> fileAccount;
